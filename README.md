...
reproducible research and practical developer tools. This September, I'm training open-source language models and exploring on-device LLM inference, including MLX, multi-token prediction (MTP) drafters, speculative decoding, and optimizing neural processing on Apple Silicon. After that, it's back to app development.
<div align="center">
